namespace Anjeer_Gifts.Configuration;

public class Constants
{
    public const string BOTTOKEN = "6312356161:AAG7hyr4czOTwJSYk5H8Lv64M7Mq404G7-k";
    public const string ORDERPATH = "../../../../Anjeer-Gifts/Database/Orders.json";
    public const string GIFTBOXPATH = "../../../../Anjeer-Gifts/Database/GiftBoxes.json";
    public const string PRODUCTPATH = "../../../../Anjeer-Gifts/Database/Products.json";
